...
const base =
  "rounded-[10px] font-semibold cursor-pointer transition-all duration-200 text-sm";
...
const variantClasses = {
  ...
  link: "relative  text-sm font-extralight text-text-secondary hover:text-text-primary rounded-[100px] transition-colors duration-300 font-sans after:absolute after:bottom-[1px] after:left-0 after:w-full after:h-px after:bg-current after:origin-left after:scale-x-0 after:transition-transform after:duration-300 hover:after:scale-x-100",
  ...
  "hero-secondary":
    ...
    " bg-btnSecondaryBg border border-btnSecondaryBorder text-text hover:border-btnSecondaryHoverBorder hover:bg-accentGlow",
  
  "filter-toggle":
    "px-4 py-2 bg-surface2 border border-border text-textSecondary hover:border-accent hover:text-accent flex items-center gap-2",
};
