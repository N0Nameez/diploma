...
const variantClasses = {
  primary: 'px-5 py-2 bg-btn-primary-bg text-btn-primary-text hover:bg-btn-primary-hover hover:text-white shadow-[0_0_20px_var(--accent-glow)] hover:opacity-[0.88] hover:-translate-y-px hover:shadow-[0_4px_24px_var(--accent-glow)]',
